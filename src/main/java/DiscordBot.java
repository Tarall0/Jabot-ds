...
public class DiscordBot {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        JDA bot = builder
                ...
                .addEventListeners(new GenericMessage(), new SlashCommands(), new MemberJoin(), new SelectRoles(), new SpinWheel(), new HourlyMessage(), new Leveling(), new CryptoCurrencyList())
                .build()
                .awaitReady();
